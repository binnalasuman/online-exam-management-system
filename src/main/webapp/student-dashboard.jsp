  ...
  <style>
    ...
    * {
    ...
    .sidebar {
      ...
      box-shadow: 0 8px 24px rgba(252, 182, 159, 0.25);
      display: flex;
    ...
    .sidebar nav a.active {
      background: #fcb69f;
      color: #ffffffcc;
      box-shadow: 0 4px 14px #fcb69fcc;
    ...
    header h1 {
      ...
      font-size: 2.5rem;
      color: #cf4b26;
      text-shadow: 1px 2px 6px rgba(252, 182, 159, 0.5);
    }
    .profile {
      display: flex;
      align-items: center;
      ...
      padding: 10px 16px;
      border-radius: 12px;
      box-shadow: 0 6px 14px rgba(252, 182, 159, 0.25);
    }
    .profile img {
      width: 52px;
      height: 52px;
    ...
    .card:hover {
      ...
      box-shadow: 0 12px 40px rgba(252, 182, 159, 0.45);
    }
    .card h3 {
      font-weight: 600;
      color: #cf4b26;
    ...
    tbody tr {
      background: #fff9f6cc;
      border-radius: 16px;
      box-shadow: 0 8px 24px rgba(252, 182, 159, 0.15);
...
<svg xmlns="http://www.w3.org/2000/svg" 
  ...
  <path d="M12 12c2.7 0 5-2.3 5-5s-2.3-5-5-5-5 2.3-5 5 2.3 5 5 5zm0 2c-3.3 0-10 1.7-10 5v3h20v-3c0-3.3-6.7-5-10-5z"/>
    ...
    <section>
      <h2 style="color:#cf4b26; margin-bottom:1.5rem;">Recent Exam Status</h2>
      <table>
        <thead>
          <tr>
            <th>Exam Name</th>
        ...
        <tbody>
          ...
          <tr>
            <td>History Midterm</td>
            <td>2025-08-08</td>
            <td class="status Missed">Missed</td>
          </tr>
          <tr>
            <td>English Test</td>
            <td>2025-08-05</td>
